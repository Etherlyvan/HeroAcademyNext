...
const studentNavItems = [
  ...
  { href: "/student/classes", label: "Kelas Saya", icon: BookOpen },
  { href: "/student/assignments", label: "Tugas Saya", icon: FileText },
  { href: "/student/hero-ai", label: "Hero AI", icon: Brain },
  { href: "/student/achievements", label: "Pencapaian", icon: Trophy },
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:pt-16 bg-card border-r border-border">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="px-4 mb-6">
              <h2 className="text-lg font-semibold text-foreground">Student Panel</h2>
